...
from ansible.module_utils.network.fos.fos import get_config, get_sublevel_config
from ansible.module_utils.network.fos.fos import fos_argument_spec
from ansible.module_utils.network.fos.fos import load_config, run_commands
#from ansible.module_utils.network.fos.fos import WARNING_PROMPTS_RE
